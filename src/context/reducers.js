...
const reducer = (state,action)=>{
    ...
    if(action.type===HANDLE_CHANGE){
        return{
            ...state,
            [action.payload.name]: action.payload.value //dynamicaly access the property name
        }
    }
    ...
    if(action.type===SET_EDIT_JOB){
        const job = state.jobs.find((job)=>job._id===action.payload.id)//state has jobs array iterate over it to find a job whose idmatchesaction.payload.id
